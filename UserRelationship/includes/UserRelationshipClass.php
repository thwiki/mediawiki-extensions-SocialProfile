...
class UserRelationship {
	...
	public function sendRelationshipRemoveEmail( $user, $type ) {
		...
		$userOptionsLookup = MediaWikiServices::getInstance()->getUserOptionsLookup();
		$wantsEmail = ExtensionRegistry::getInstance()->isLoaded( 'Echo' ) ? $userOptionsLookup->getBoolOption( $user, 'echo-subscriptions-email-social-rel' ) : $userOptionsLookup->getIntOption( $user, 'notifyfriendrequest', 1 );
